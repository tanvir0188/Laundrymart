...
class Order(models.Model):
    ...
    # Uber tracking
    uber_pickup_quote_id = models.CharField(max_length=100, blank=True, null=True)
    uber_pickup_delivery_id = models.CharField(max_length=100, blank=True, null=True)
    uber_return_quote_id = models.CharField(max_length=100, blank=True, null=True)
    uber_return_delivery_id = models.CharField(max_length=100, blank=True, null=True)
