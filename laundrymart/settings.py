"""
Django settings for laundrymart project.
...
CUSTOMER_CONFIRM_ORDER_STRIPE_WEBHOOK_SECRET=os.getenv('CUSTOMER_CONFIRM_ORDER_STRIPE_WEBHOOK_SECRET')
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://127.0.0.1:6378/0",  # host:port/db
        "OPTIONS": {
